...
export default function ListPessoaAsync({ navigation, route }) {
  ...
  async function loadPessoas() {
    ...
    console.log("🚀 ~ file: ListPessoaAsyncStorage.js:21 ~ loadPessoas ~ response:", response)
  ...
  return (
    <View style={styles.container}>
      ...
      <FAB
        icon="plus"
        style={styles.fab}
        onPress={() => navigation.push('FormPessoaAsync', { acao: adicionarPessoa })}
      />
